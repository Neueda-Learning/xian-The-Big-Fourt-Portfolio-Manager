INSERT INTO portfolio (pro_name, pro_description, initial_cash, cash_balance) VALUES ('Stable Growth Portfolio', 'Blue-chip stocks and govt bonds, long-term holding', 100000.0000, 50000.0000);
INSERT INTO portfolio (pro_name, pro_description, initial_cash, cash_balance) VALUES ('Tech Pioneer Portfolio', 'High-growth tech stocks, higher risk appetite', 80000.0000, 15000.0000);
INSERT INTO holding (portfolio_id, asset_type, ticker, quantity, average_price, current_price, purchase_date, currency) VALUES (1, 'STOCK', 'AAPL', 100.0000, 185.5000, 185.5000, '2026-01-15', 'USD');
INSERT INTO holding (portfolio_id, asset_type, ticker, quantity, average_price, current_price, purchase_date, currency) VALUES (1, 'STOCK', 'MSFT', 50.0000, 420.3000, 420.3000, '2026-02-01', 'USD');
INSERT INTO holding (portfolio_id, asset_type, ticker, quantity, average_price, current_price, purchase_date, currency) VALUES (1, 'BOND', 'US10Y', 50.0000, 98.5000, 98.5000, '2026-01-20', 'USD');
INSERT INTO holding (portfolio_id, asset_type, ticker, quantity, average_price, current_price, purchase_date, currency) VALUES (2, 'STOCK', 'TSLA', 30.0000, 280.0000, 280.0000, '2026-04-01', 'USD');
INSERT INTO holding (portfolio_id, asset_type, ticker, quantity, average_price, current_price, purchase_date, currency) VALUES (2, 'STOCK', 'NVDA', 20.0000, 880.5000, 880.5000, '2026-04-01', 'USD');
